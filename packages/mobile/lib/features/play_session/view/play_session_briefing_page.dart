...
class PlaySessionBriefingPage extends StatefulWidget {
  const PlaySessionBriefingPage({
    ...
    super.key,
         ...
         libraryEntryPublicId != null || playSessionPublicId != null,
         'Either libraryEntryPublicId or playSessionPublicId must be provided.',
       );
...
class _PlaySessionBriefingPageState extends State<PlaySessionBriefingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocConsumer<PlaySessionBloc, PlaySessionState>(
